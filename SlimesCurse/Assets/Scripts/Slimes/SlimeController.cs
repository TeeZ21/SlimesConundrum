...
{
    [SerializeField] private ESlimeTypes _slimeType = ESlimeTypes.BLACK;

    public ESlimeTypes SlimeTypes
    {
        get 
        {
            return _slimeType; 
    ...
    {
        dir = Vector3.up;
        InvokeRepeating("Start", 0f, 5f);
    }
    void Start()
    {
        play = true;
        direction = new Vector3(Random.Range(-6.0f, 6.0f), Random.Range(-6.0f, 6.0f), 0); //random position in x and y
    }
    void Update()
    {
